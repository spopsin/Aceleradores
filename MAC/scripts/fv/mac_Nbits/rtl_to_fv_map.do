...
# Generated on: Mon Sep 22 11:09:21 -03 2025 (Mon Sep 22 14:09:21 UTC 2025)
...
set logfile fv/mac_Nbits/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/mac_Nbits -revised fv_map -use_rtl_names
...
add_search_path ../gpdk045_workspace/gsclib045_all_v4.4/gsclib045/timing -library -both
read_library -liberty -both \
    /home/inf01185/sofia.gomes/MAC/scripts/../gpdk045_workspace/gsclib045_all_v4.4/gsclib045/timing/slow_vdd1v0_basicCells.lib
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../rtl/mac_Nbits.v
elaborate_design -golden -root {mac_Nbits} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/mac_Nbits/fv_map.v.gz
elaborate_design -revised -root {mac_Nbits}
...
set_analyze_option -mapping_file fv/mac_Nbits/fv_map.map.do
...
set_system_mode lec
write_compared_points noneq.compared_points.mac_Nbits.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.mac_Nbits.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.mac_Nbits.rtl.fv_map.rpt
